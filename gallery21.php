...
<li>
				...
				<ul class="items">
					<li>
						<div class="frame">
							<img src="images/baklava.jpg"height="260" width="400" alt="Img">
						</div>
						<h5>Baklava
</h5>
<p>  aklava is a rich, sweet dessert pastry made of layers of filo filled with chopped nuts and sweetened and held together with syrup or honey.
</p>						
						<span class="price">Rs.170</span>
					</li>
					<li>
						<div class="frame">
							<img src="images/mango.jpg"height="260" width="400" alt="Img">
						</div>
						<h5>Mango Pastry</h5>
<p> Mango turnovers are a sweet treat that can be eaten as dessert or afternoon snack.</p>
				
						<span class="price">Rs160.00</span>
					</li>
				</ul>
				<div id="pagination">
					<ul>
