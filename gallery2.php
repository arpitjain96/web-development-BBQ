		...
		<div>
			<div class="body"  id="gallery">
				...
				<ul class="items">
					<li>
						<div class="frame">
							<img src="images/gulab.jpg"height="260" width="400" alt="Img">
						</div>
						<h5>Gulab Jamun</h5>
						<p>Gulab jamun is a milk-solid-based South Asian sweet, particularly popular in India, Myanmar, Nepal, Pakistan and Bangladesh.
</p>						
						<span class="price">Rs.130</span>
					</li>
					<li>
						<div class="frame">
							<img src="images/gulkand.jpg"height="260" width="400" alt="Img">
						</div>
						<h5>Gulkand Phirnee</h5>
						<p> Gulkand Phirni -Candied rose and rose syrup add a lovely colour and flavour to the phirni.
</p>
				
						<span class="price">Rs69.00</span>
					</li>
				</ul>
				<div id="pagination">
					<ul>
